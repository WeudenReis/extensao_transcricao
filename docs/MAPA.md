...
| Arquivo | O que resolve | Exporta |
|---|---|---|
| `extension/content/aba-reuniao.js` (655) | A aba "Reunião" — o painel do Copiloto, feito do mesmo material. | __cpmAba |
...
| `extension/content/fluxo-reuniao.js` (3143) | O fluxo de marcar reunião, passo a passo, dentro da aba lateral. | __cpmFluxo |
